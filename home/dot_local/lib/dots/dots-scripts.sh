...
scripts_list=(
  ...
  "🔒 hyprlock: Manage wallpapers on Wayland with swaybg/hyprpaper"
  ...
  "🎨 wal-reload: Reload pywal colorscheme and apply smart colors to i3, rofi, eww, polybar, betterlockscreen, Hyprland, Waybar, Mako"
