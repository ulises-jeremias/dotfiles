...
notify-send "Gruvbox Videogame 3D Art Config" "Applying Gruvbox Videogame 3D Art rice..."

if ! command -v wpg &>/dev/null; then
  echo "wpg not found. Please install wpg."
  notify-send "Gruvbox Videogame 3D Art Config" "wpg not found. Please install wpg."
  exit 1
fi
