...
notify-send "Gruvbox Pixelart Config" "Applying Gruvbox Pixelart rice..."

if ! command -v wpg &>/dev/null; then
  echo "wpg not found. Please install wpg."
  notify-send "Gruvbox Pixelart Config" "wpg not found. Please install wpg."
  exit 1
fi
...
notify-send "Gruvbox Pixelart Config" "Gruvbox Pixelart rice applied successfully."
