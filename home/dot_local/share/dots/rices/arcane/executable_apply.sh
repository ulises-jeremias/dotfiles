...
notify-send "ArcaneConfig" "Applying Arcane rice..."

if ! command -v wpg &> /dev/null; then
	echo "wpg not found. Please install wpg."
	notify-send "ArcaneConfig" "wpg not found. Please install wpg."
	exit 1
fi
...
notify-send "ArcaneConfig" "Arcane rice applied successfully."
