...
notify-send "HorneroConfig" "Applying Monochrome rice... ◑"
...
if [[ ${#image_files[@]} -eq 0 ]]; then
  notify-send "HorneroConfig" "Monochrome: no wallpapers found in backgrounds/."
  exit 0
fi
...
notify-send "HorneroConfig" "Monochrome rice applied! ◑ Pure clarity."
