...
notify-send "Gruvbox Minimalistic Config" "Applying Gruvbox Minimalistic rice..."

if ! command -v wpg &> /dev/null; then
	echo "wpg not found. Please install wpg."
	notify-send "Gruvbox Minimalistic Config" "wpg not found. Please install wpg."
	exit 1
fi
...
notify-send "Gruvbox Minimalistic Config" "Gruvbox Minimalistic rice applied successfully."
