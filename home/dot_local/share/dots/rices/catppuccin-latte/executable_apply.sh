...
notify-send "HorneroConfig" "Applying Catppuccin Latte rice... ☕"
...
if [[ ${#image_files[@]} -eq 0 ]]; then
  notify-send "HorneroConfig" "Catppuccin Latte: no wallpapers found in backgrounds/."
  exit 0
fi
...
notify-send "HorneroConfig" "Catppuccin Latte rice applied! ☕ Warm and welcoming."
