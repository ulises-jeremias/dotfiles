...
notify-send "PastelDreamsConfig" "Applying PastelDreams rice..."

if ! command -v wpg &>/dev/null; then
  echo "wpg not found. Please install wpg."
  notify-send "PastelDreamsConfig" "wpg not found. Please install wpg."
  exit 1
fi
...
notify-send "PastelDreamsConfig" "PastelDreams rice applied successfully."
