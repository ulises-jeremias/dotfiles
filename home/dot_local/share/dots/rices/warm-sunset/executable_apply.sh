...
notify-send "WarmSunsetConfig" "Applying WarmSunset rice..."

if ! command -v wpg &>/dev/null; then
  echo "wpg not found. Please install wpg."
  notify-send "WarmSunsetConfig" "wpg not found. Please install wpg."
  exit 1
fi
...
notify-send "WarmSunsetConfig" "WarmSunset rice applied successfully."
