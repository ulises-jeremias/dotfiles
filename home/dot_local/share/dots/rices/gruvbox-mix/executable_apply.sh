...
notify-send "Gruvbox Mix Config" "Applying Gruvbox Mix rice..."

if ! command -v wpg &>/dev/null; then
  echo "wpg not found. Please install wpg."
  notify-send "Gruvbox Mix Config" "wpg not found. Please install wpg."
  exit 1
fi
...
notify-send "Gruvbox Mix Config" "Gruvbox Mix rice applied successfully."
