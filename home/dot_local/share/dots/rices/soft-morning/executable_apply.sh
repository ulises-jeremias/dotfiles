...
notify-send "SoftMorningConfig" "Applying SoftMorning rice..."

if ! command -v wpg &>/dev/null; then
  echo "wpg not found. Please install wpg."
  notify-send "SoftMorningConfig" "wpg not found. Please install wpg."
  exit 1
fi
...
notify-send "SoftMorningConfig" "SoftMorning rice applied successfully."
