...
3. Run `horneroctl appearance colors generate --yes`
...
1. **Regenerate the theme**:
   ...
   ```bash
   horneroctl appearance colors generate --yes
   ```
...
3. **Smart Colors Regeneration**: Running `horneroctl appearance colors generate --yes`
...
- The theme file is generated by `horneroctl appearance colors generate --yes` with current smart-colors
